...
struct ListStopsMatched: View {
    @EnvironmentObject private var gtfsStatic: GTFSStaticViewModel
    ...
    var body: some View {
        ...
        LazyVStack(
            ...
            ForEach(listStops) { stop in
                ...
                RowStopSearch(stop: stop, highlight: gtfsStatic.searchQuery) {
                    self.locationManager.moveCamera(to: CLLocationCoordinate2D(latitude: stop.latitude, longitude: stop.longitude))
